...
const Movies = (props) => {
    ...
    const [searchProp, setSearchProp] = useState(`movie/now_playing?api_key=${tmdbKey}&language=en-US&page=${pageNum}`);
    ...
    return (
        <div>
            ...
            <Pagination numOfPages={numOfPages} path={props.match} />
